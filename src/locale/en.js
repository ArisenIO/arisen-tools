export default {
  ...
  'RIX Block Explorer': 'RIX Block Explorer',
  ...
  Staked: 'Staked',
  Error: 'Error',
  'Insufficient available RIX balance to complete transaction. Or Unable to set staked amount to 0. Doing so would prevent you from performing any transactions on the network.':
    'Insufficient available RIX balance to complete transaction. Or Unable to set staked amount to 0. Doing so would prevent you from performing any transactions on the network.',
  Actions: 'Actions',
  ID: 'ID',
  TYPE: 'TYPE',
  ...
  'This Constitution may be executed in any number of counterparts, each of which when executed and delivered shall constitute a duplicate original, but all counterparts together shall constitute a single agreement.':
    'This Constitution may be executed in any number of counterparts, each of which when executed and delivered shall constitute a duplicate original, but all counterparts together shall constitute a single agreement.',
  'Set RIX staked in CPU': 'Set RIX staked in CPU',
  'Set RIX staked in NET': 'Set RIX staked in NET',
  ...
  'RAM purchase (in RIX)': 'RAM purchase (in RIX)',
  ...
  'Available RIX (liquid)': 'Available RIX (liquid)',
